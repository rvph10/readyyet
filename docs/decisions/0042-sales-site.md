...
- The pages that sell ReadyYet (home, business types, pricing, FAQ, legal) are their own Next.js app, `site/`, next to `web/` in the monorepo. `site/` serves `readyyet.app`, and `web/` serves `app.readyyet.app`.
