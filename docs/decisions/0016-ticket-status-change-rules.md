...
7. **Undo within 2 minutes.** The latest change can be undone for 2 minutes after it was made, only by the User who made it: its Status event is deleted and the ticket goes back to the previous Status, as if the change never happened. After that, a correction is an ordinary new change. A ticket's first `RECEIVED` event can't be undone.
